...
<div class="page">
   <div class="page-header">
      <h1 class="page-title">Portfolio Kateqoriyaları</h1>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td> 
                           ...
                           <a href="portfolio-kateqoriyalari.php?id=<?= $k_data[$i]['id']?>&status=deaktiv"><button class="btn btn-danger btn-sm">Deaktiv Et</button></a>
                           <?php endif ?>
                           <?php if ($k_data[$i]['status']==0): ?>
                           <a href="portfolio-kateqoriyalari.php?id=<?= $k_data[$i]['id']?>&status=aktiv"><button class="btn btn-info btn-sm">Aktiv Et</button></a>
                           <?php endif ?>
                        </td>
...
<script>
   function sil(id) {
     x = confirm("Portfolio Kateqoriyasının silinməsinə əminsinizmi?");
     if (x) {
       window.location.href = "portfolio-kateqoriyalari.php?status=sil&id="+id;
     }
     else{
       alert("İmtina edildi!");
     }
